...
So the Rust core is justified — *if and only if V2 hardware or the on-prem appliance materializes.* This ADR enshrines that "if" as a Phase 2 re-evaluation gate.
