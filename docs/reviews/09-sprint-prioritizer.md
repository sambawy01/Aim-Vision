...
3. **RTL and i18n architecture from Sprint 3, not Sprint 18.** Arabic for the design partner means RTL must inform the layout primitives, navigation, and component library _before_ any screen is shipped. Move "i18n framework + RTL-safe component library" into Sprint 3 EPIC 3.3. Translations can wait; layout decisions cannot.
