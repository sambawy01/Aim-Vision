...
- ADRs: [0001 Backend Python+FastAPI](docs/adr/0001-backend-python-fastapi.md) · [0002 Mobile RN New Architecture](docs/adr/0002-mobile-rn-new-architecture.md) · [0003 Rust camera-core split](docs/adr/0003-rust-camera-core-split.md) · [0004 Multi-tenancy RLS](docs/adr/0004-multi-tenancy-rls.md) · [0005 CloudNativePG cloud↔on-prem parity](docs/adr/0005-cloudnativepg-cloud-onprem-parity.md) · [0006 Event sourcing for shot events](docs/adr/0006-event-sourcing-shot-events.md) · [0007 Temporal orchestration](docs/adr/0007-temporal-orchestration.md) · [0008 Build vs buy](docs/adr/0008-build-vs-buy.md) · [0009 Phone capture dev backend](docs/adr/0009-phone-capture-dev-backend.md) · [0010 Identity provider Supabase](docs/adr/0010-identity-provider-supabase.md) · [0011 Parental consent Stripe-only at launch](docs/adr/0011-parental-consent-stripe-only.md) · [0012 On-prem-first GA](docs/adr/0012-on-prem-first-ga.md) · [0013 First app store Google Play](docs/adr/0013-first-app-store-google-play.md) · [0014 Coaching-note LLM hosted API](docs/adr/0014-coaching-note-llm-hosted-api.md) · [0015 Phase-1 ships minor-athlete support](docs/adr/0015-phase-1-ships-minor-athlete-support.md) · [0016 Pilot venue Egypt National Team](docs/adr/0016-pilot-venue-egypt-national-team.md)
...
**Last updated:** 2026-05-24 19:15:00 UTC
**Branch:** `main` · **Commits:** 157 · **Tracked files:** 499
**Remote:** https://github.com/sambawy01/Aim-Vision

### Recent commits
- fc8957e feat(backend): POST /auth/exchange — GoTrue JWT → AIMVISION session (ADR-0010 step 2) (#95) (sambawy01, 8 seconds ago)
- 434181f feat(backend): GoTrue JWT verifier behind AUTH_PROVIDER flag (ADR-0010 step 1) (#94) (sambawy01, 3 hours ago)
- 39aff78 docs: production build plan — workstreams, phasing, integrations, gates (#93) (sambawy01, 3 hours ago)
- 95ceff1 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 2 days ago)
- abb594b fix(auth+web): make local sign-in and core flows actually work (#88) (sambawy01, 2 days ago)
- 70c638e chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 2 days ago)
- 13bf66b feat(mobile): gate dev-mode phone capture behind capture.phone_backend_enabled (#87) (sambawy01, 2 days ago)
- f2e49f1 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 2 days ago)
- 12c00a4 feat(ml): per-class recall floor in the diagnostic promotion gate (#86) (sambawy01, 2 days ago)
- c69af2b chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 2 days ago)
...
- aimvision-backend/alembic/versions/0015_users_gotrue_sub.py
