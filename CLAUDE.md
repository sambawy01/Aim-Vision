...
**Last updated:** 2026-05-12 20:40:45 UTC
**Branch:** `main` · **Commits:** 37 · **Tracked files:** 337
**Remote:** https://github.com/sambawy01/Aim-Vision

### Recent commits
- 1dc271d chore(camera-core): cargo fmt --all + promote fmt gate to blocking (#28) (sambawy01, 17 seconds ago)
- d41a446 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 10 minutes ago)
- bab30ca chore(mobile): commit pnpm-lock.yaml + pin pnpm 9.15.9, flip CI to frozen (#27) (sambawy01, 11 minutes ago)
- 19391ce chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 18 minutes ago)
- 7806aa1 ci(camera-core): re-promote cargo clippy to blocking (#26) (sambawy01, 19 minutes ago)
- 0009d2b chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 26 minutes ago)
- 47b665d chore(camera-core): drop no-op .map(|()| ()) in state_transitions tests (#25) (sambawy01, 26 minutes ago)
- 274f1e8 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 40 minutes ago)
- f78fb11 mobile(env+flags): app.config.ts overlay, .env.example, real flag consumer (#24) (sambawy01, 40 minutes ago)
- eb715f3 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 70 minutes ago)
