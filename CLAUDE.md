...
**Last updated:** 2026-05-12 20:00:52 UTC
**Branch:** `main` · **Commits:** 29 · **Tracked files:** 336
**Remote:** https://github.com/sambawy01/Aim-Vision

### Recent commits
- f78fb11 mobile(env+flags): app.config.ts overlay, .env.example, real flag consumer (#24) (sambawy01, 18 seconds ago)
- eb715f3 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 31 minutes ago)
- 2867ddf fix(ci): state machine send_replace + pin @typescript-eslint to v7 (#22) (sambawy01, 31 minutes ago)
...
- 2ebf216 fix(ci): tokio test-util feature + simpler mobile eslint config (sambawy01, 6 days ago)
- 5de0f66 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 6 days ago)
