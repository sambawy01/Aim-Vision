...
**Last updated:** 2026-05-22 12:37:21 UTC
**Branch:** `main` · **Commits:** 147 · **Tracked files:** 483
**Remote:** https://github.com/sambawy01/Aim-Vision

### Recent commits
- a0e62ad feat(web): right-to-erasure request UI (file + execute crypto-shred) (#85) (sambawy01, 9 seconds ago)
- fd0a7fb chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 6 hours ago)
- fbd51f5 feat(backend): right-to-erasure foundation — per-tenant crypto-shred + erasure ledger (#84) (sambawy01, 6 hours ago)
- 096cb70 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 6 hours ago)
- 06480dd feat(backend): wire finalize_session activity to the real backend API (#83) (sambawy01, 6 hours ago)
...
- c3e189b chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 7 hours ago)
- 0bc84e2 feat(web): render the coaching note on session detail (#81) (sambawy01, 7 hours ago)
- c0dac07 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 7 hours ago)
