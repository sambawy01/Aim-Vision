...
**Last updated:** 2026-05-12 20:22:20 UTC
**Branch:** `main` · **Commits:** 33 · **Tracked files:** 336
**Remote:** https://github.com/sambawy01/Aim-Vision

### Recent commits
- 7806aa1 ci(camera-core): re-promote cargo clippy to blocking (#26) (sambawy01, 18 seconds ago)
- 0009d2b chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 8 minutes ago)
- 47b665d chore(camera-core): drop no-op .map(|()| ()) in state_transitions tests (#25) (sambawy01, 8 minutes ago)
- 274f1e8 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 21 minutes ago)
- f78fb11 mobile(env+flags): app.config.ts overlay, .env.example, real flag consumer (#24) (sambawy01, 22 minutes ago)
- eb715f3 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 52 minutes ago)
- 2867ddf fix(ci): state machine send_replace + pin @typescript-eslint to v7 (#22) (sambawy01, 52 minutes ago)
- fc83ea1 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 6 days ago)
- a8b1bf4 Merge branch 'main' of https://github.com/sambawy01/Aim-Vision (sambawy01, 6 days ago)
- 8c796d5 docs(CLAUDE.md): record Sprint 3 CI debugging state for next session (sambawy01, 6 days ago)
