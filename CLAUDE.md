...
**Last updated:** 2026-05-22 06:08:25 UTC
**Branch:** `main` · **Commits:** 143 · **Tracked files:** 472
**Remote:** https://github.com/sambawy01/Aim-Vision

### Recent commits
- 06480dd feat(backend): wire finalize_session activity to the real backend API (#83) (sambawy01, 8 seconds ago)
- 94aa831 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 6 minutes ago)
- 333705f feat(backend): GET /athletes/{id}/progress — longitudinal diagnostic rollups (#82) (sambawy01, 6 minutes ago)
- c3e189b chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 31 minutes ago)
- 0bc84e2 feat(web): render the coaching note on session detail (#81) (sambawy01, 31 minutes ago)
- c0dac07 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 33 minutes ago)
- ab642bf feat(backend): coaching-note persistence (POST/GET /sessions/{sid}/coaching-note) (#80) (sambawy01, 33 minutes ago)
- a01be49 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 41 minutes ago)
- be35415 feat(backend): global drill catalog + GET /drills (#79) (sambawy01, 42 minutes ago)
- fb0d48a chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 24 hours ago)
...
- aimvision-backend/app/schemas/orgs.py
- aimvision-backend/app/schemas/progress.py
