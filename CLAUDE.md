...
**Last updated:** 2026-05-19 18:53:16 UTC
**Branch:** `main` · **Commits:** 101 · **Tracked files:** 418
**Remote:** https://github.com/sambawy01/Aim-Vision

### Recent commits
- 8e485ff feat(backend): session lifecycle close + partial_session flag (#62) (sambawy01, 10 seconds ago)
- 3db8a35 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 32 minutes ago)
- a36b9a7 feat(backend): session summary endpoint for post-session readiness (#61) (sambawy01, 32 minutes ago)
- b286b45 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 60 minutes ago)
- d4d7b28 feat(backend): ShotEvent ingest endpoints (ADR-0006 append-only event stream) (#60) (sambawy01, 60 minutes ago)
- 7a83e16 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 84 minutes ago)
- 56b97f5 feat(backend): Shot ingest endpoints (ADR-0006 append-only) (#59) (sambawy01, 84 minutes ago)
- 679f86e chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 2 hours ago)
- 5587dee feat(backend): calibration health endpoint (multi-camera-sync-spec §4.4 trigger) (#58) (sambawy01, 2 hours ago)
- eee6996 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 2 hours ago)
...
- aimvision-backend/tests/test_authz.py
- aimvision-backend/tests/test_calibration_health_endpoint.py
- aimvision-backend/tests/test_camera_calibration_endpoint.py
- aimvision-backend/tests/test_federation_dashboard.py
- aimvision-backend/tests/test_federation_schema_v2.py
<!-- AUTO:END -->
