...
**Last updated:** 2026-05-19 22:41:40 UTC
**Branch:** `main` · **Commits:** 125 · **Tracked files:** 447
**Remote:** https://github.com/sambawy01/Aim-Vision

### Recent commits
- a470195 feat(ml): diagnostic-head ONNX inference + export pipeline (no weights shipped) (#74) (sambawy01, 10 seconds ago)
- b057369 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 32 minutes ago)
- 21e0532 feat(web): Run post-session pipeline button on SessionDetail (#73) (sambawy01, 32 minutes ago)
- dca9ade chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 44 minutes ago)
- 8fef9d0 feat(ml): aimvision-ml ingest CLI — operator wrappers over BackendClient (#72) (sambawy01, 45 minutes ago)
- 1509479 chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 51 minutes ago)
- 2822eb6 feat(backend): GET /cohorts — tenant-scoped cohort listing with athletes_count (#71) (sambawy01, 51 minutes ago)
- 4e043bf chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 77 minutes ago)
- a79a815 feat(backend+web): GET /orgs + org-picker dropdown in new-session form (#70) (sambawy01, 77 minutes ago)
- 4d4ba4e chore(context): refresh CLAUDE.md auto block [skip-context] (github-actions[bot], 2 hours ago)
...
- aimvision-backend/app/services/authz.py
- aimvision-backend/app/services/storage.py
- aimvision-backend/app/services/tenancy.py
- aimvision-backend/app/services/workflows.py
- aimvision-backend/app/workflows/__init__.py
- aimvision-backend/app/workflows/activities/__init__.py
- aimvision-backend/app/workflows/activities/post_session.py
<!-- AUTO:END -->
